...
├── HimeshBhan_AdPrediction.py               ← All backend ML + Flask frontend (one file)
├── requirements.txt     ← Python dependencies
├── README.md            ← This file
└── Social_Network_Ads.csv  ← https://www.kaggle.com/datasets/rakeshrau/social-network-ads?resource=download
...
```bash
python HimeshBhan_AdPrediction.py
```
...
All configuration lives at the top of `HimeshBhan_AdPrediction.py`:
